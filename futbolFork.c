...
//Globals cos reasons
pthread_mutex_t lock; //Borrar creo
...
int main(){
    ...
    //Program
    int* goalA = (int*) create_shared_memory( sizeof(int) );
    int* goalB = (int*) create_shared_memory( sizeof(int) );
    int* ball  = (int*) create_shared_memory( sizeof(int) );
